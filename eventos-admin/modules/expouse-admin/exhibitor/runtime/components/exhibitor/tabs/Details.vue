...
const {
  ...
  error, saving, update, remove, drawerMode,
} = useExhibitorContext()
...
// (filter title → heading → options). Selections are stored on the
// exhibitor as filterId → heading → chosen options.
...
<template>
  <div>
    ...
    <div v-else class="flex flex-col gap-2 my-1.5">
