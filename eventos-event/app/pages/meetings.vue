    ...
    <div class="grid">
      <div class="col">
        ...
        <div class="toprow">
          ...
          <div class="fselect">
            <select v-model="tz" title="Timezone">
      ...
      <aside class="rail">
        ...
        <div class="group">
          ...
          <div class="chips">
            <button v-for="s in statusOptions" :key="s.key" type="button" class="chip"
              :class="{ on: selectedStatuses.includes(s.key) }" @click="toggle('statuses', s.key)">{{ s.label
              }}</button>
          </div>
        </div>
        ...
        <div v-if="hostOptions.length" class="group">
          ...
          <div class="chips">
            <button v-for="h in hostOptions" :key="h" type="button" class="chip"
              :class="{ on: selectedHosts.includes(h) }" @click="toggle('hosts', h)">{{ h }}</button>
          </div>
        </div>
        ...
        <div v-if="locationOptions.length" class="group">
          ...
          <div class="chips">
            <button v-for="l in locationOptions" :key="l" type="button" class="chip"
              :class="{ on: selectedLocations.includes(l) }" @click="toggle('locations', l)">{{ l }}</button>
          </div>
        </div>
      </aside>
    </div>
