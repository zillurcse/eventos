...
<template>
  <div class="change-password">
    <div class="field">
      ...
      <input id="cp-current" v-model="currentPassword" type="password" placeholder="Enter Current Password"
        autocomplete="current-password">
    </div>

    <div class="field">
      <label for="cp-new">New Password<span class="req">*</span></label>
      <input id="cp-new" v-model="password" type="password" placeholder="Enter New Password"
        autocomplete="new-password">
    </div>

    <div class="field">
      <label for="cp-confirm">Confirm Password<span class="req">*</span></label>
      <input id="cp-confirm" v-model="confirmPassword" type="password" placeholder="Enter Confirm Password"
        autocomplete="new-password">
    </div>
