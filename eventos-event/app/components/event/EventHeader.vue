    ...
    <div class="inner">
      ...
      <nav class="tabs" aria-label="Event sections">
        <template v-for="t in tabs" :key="t.key">
          <NuxtLink v-if="t.to" :to="t.to" class="tab" :class="{ active: route.path === t.to }">
      ...
      <nav class="utils" aria-label="Quick actions">
        ...
        <button class="util" type="button" title="Leaderboard" aria-label="Leaderboard" disabled>
          <svg viewBox="0 0 24 24">
            <path d="M7 4h10v3a5 5 0 0 1-10 0zM7 5H4v2a3 3 0 0 0 3 3M17 5h3v2a3 3 0 0 1-3 3M9 15h6l-1 5h-4z" />
          </svg>
        </button>
