...
class EventController extends Controller
{
    ...
    public function updateSettings(string $uuid, Request $request): JsonResponse
    {
        ...
        $data = $request->validate([
            ...
            'help_screens' => ['sometimes', 'array'],
            'help_screens.*.id' => ['sometimes', 'string'],
            'help_screens.*.title' => ['sometimes', 'nullable', 'string', 'max:200'],
            'help_screens.*.description' => ['sometimes', 'nullable', 'string', 'max:1000'],
            'help_screens.*.image_file_id' => ['sometimes', 'nullable', 'integer'],
            'help_screens.*.image_url' => ['sometimes', 'nullable', 'string', 'max:1000'],
            'help_screens.*.active' => ['sometimes', 'boolean'],
            'manage_tabs' => ['sometimes', 'array'],
            'manage_tabs.*.key' => ['sometimes', 'string', 'max:60'],
            'manage_tabs.*.label' => ['sometimes', 'string', 'max:60'],
            'manage_tabs.*.enabled' => ['sometimes', 'boolean'],
            'branded_app' => ['sometimes', 'array'],
            'branded_app.enabled' => ['sometimes', 'boolean'],
            'branded_app.app_name' => ['sometimes', 'nullable', 'string', 'max:120'],
            'branded_app.tagline' => ['sometimes', 'nullable', 'string', 'max:200'],
            'branded_app.icon_file_id' => ['sometimes', 'nullable', 'integer'],
            'branded_app.icon_url' => ['sometimes', 'nullable', 'string', 'max:1000'],
            'branded_app.splash_file_id' => ['sometimes', 'nullable', 'integer'],
            'branded_app.splash_url' => ['sometimes', 'nullable', 'string', 'max:1000'],
            'branded_app.primary_color' => ['sometimes', 'nullable', 'string', 'max:9'],
            'branded_app.ios_url' => ['sometimes', 'nullable', 'string', 'max:500'],
            'branded_app.android_url' => ['sometimes', 'nullable', 'string', 'max:500'],
            'app_banner' => ['sometimes', 'array'],
            'app_banner.*.id' => ['sometimes', 'string'],
            'app_banner.*.title' => ['sometimes', 'nullable', 'string', 'max:200'],
            'app_banner.*.description' => ['sometimes', 'nullable', 'string', 'max:500'],
            'app_banner.*.image_file_id' => ['sometimes', 'nullable', 'integer'],
            'app_banner.*.image_url' => ['sometimes', 'nullable', 'string', 'max:1000'],
            'app_banner.*.link_url' => ['sometimes', 'nullable', 'string', 'max:500'],
            'app_banner.*.active' => ['sometimes', 'boolean'],
            ...
            // Mail journeys (Emails list + 3-step wizard).
            'mail_emails' => ['sometimes', 'array'],
            'mail_emails.*.id' => ['sometimes', 'string', 'max:60'],
            'mail_emails.*.name' => ['sometimes', 'required', 'string', 'max:200'],
            'mail_emails.*.description' => ['sometimes', 'nullable', 'string', 'max:1000'],
            'mail_emails.*.mode' => ['sometimes', 'in:automated,manual'],
            'mail_emails.*.subject' => ['sometimes', 'nullable', 'string', 'max:300'],
            'mail_emails.*.event_state' => ['sometimes', 'nullable', 'string', 'max:40'],
            'mail_emails.*.sent_to' => ['sometimes', 'nullable', 'string', 'max:120'],
            'mail_emails.*.type' => ['sometimes', 'nullable', 'string', 'max:40'],
            'mail_emails.*.active' => ['sometimes', 'boolean'],
            'mail_emails.*.status' => ['sometimes', 'nullable', 'in:active,draft'],
            'mail_emails.*.date_label' => ['sometimes', 'nullable', 'string', 'max:120'],
            'mail_emails.*.from_name' => ['sometimes', 'nullable', 'string', 'max:120'],
            'mail_emails.*.from_email' => ['sometimes', 'nullable', 'string', 'max:180'],
            'mail_emails.*.cc' => ['sometimes', 'nullable', 'string', 'max:2000'],
            'mail_emails.*.bcc' => ['sometimes', 'nullable', 'string', 'max:2000'],
            'mail_emails.*.template_id' => ['sometimes', 'nullable', 'string', 'max:60'],
        ]);
    ...
    protected function settingsArray(EventSetting $s): array
    {
        return [
            ...
            'help_screens' => $s->help_screens ?? [],
            'manage_tabs' => $s->manage_tabs ?? [],
            'branded_app' => (object) ($s->branded_app ?? []),
            'app_banner' => $s->app_banner ?? [],
            'sender' => (object) $this->senderArray($s),
            'mail_emails' => $s->mail_emails ?? [],
        ];
    }
